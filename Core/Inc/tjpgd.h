...
typedef enum {
  ...
  JDR_FMT4, /* 9: Right format but not supported */
  JDR_FMT5, /* 10: Right format but not supported */
  JDR_FMT6, /* 11: Right format but not supported */
  JDR_FMT7, /* 12: Right format but not supported */
  JDR_FMT8, /* 13: Right format but not supported */
  JDR_FMT9, /* 14: Right format but not supported */
  JDR_FMT10, /* 7: Right format but not supported */
  JDR_FMT11 /* 7: Right format but not supported */
} JRESULT;
